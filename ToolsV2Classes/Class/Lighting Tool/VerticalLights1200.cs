...
namespace ToolsV2Classes
{
    ...
    public class VerticalLights1200 : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                FamilySymbol light1200Symbol = collector.OfClass(typeof(FamilySymbol))
                    ...
                    .FirstOrDefault(x => x.Name.Contains("WWI-LT-LS-03-01") || x.Name.Contains("WWI-LT-LS03-01"));
                    ...
                    foreach (Room room1 in roomList)
                    {
                        ...
                        else
                        {
                            ...
                            using (Transaction trans = new Transaction(doc, "Pataakha: " + room1.Name))
                            {
                                ...
                                if (programType == "work")
                                {
                                    ModelOfficeLights(light1200Symbol, transformedBB, room1, doc, roomLevel, mountingHeightInput, tFormBack, roomAngle);
                                }
            ...
            double mountingHeight, Transform tForm, double roomAngle)
        {
            ...
            if (roomBox != null)
            {
                ...
                int mMin = (int)Math.Ceiling(((W + 1200)/ 2400)-1);
                //int mMax = (int)Math.Ceiling(((W + 1200)/ 1800)-1);
                ...
                double y = (W + 1200) / (mMin + 1);
                double yWall = (W - (mMin - 1) * y )/ 2;
                if (y < 1800)
                {
                    y = 1800;
                    yWall = (W - (mMin - 1) * y) / 2;
