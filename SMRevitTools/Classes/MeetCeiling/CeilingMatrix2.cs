...
/*
 * Grid ceiling + Gypsum ceiling flushed
 * Innerloop vertices will not be used in this class
 */
...
namespace SMRevitTools
{
    ...
    public class CeilingMatrix2 : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                {   
                    ...
                    CurveLoop gridInnerVertexLoop = new CurveLoop();//INNER LOOP NOT USED IN THIS TOOL
                    for (int i = 0; i < 4; i++)
                    {
                    ...
                    var gypCeiling = Ceiling.Create(doc, new List<CurveLoop> { roomVertexLoop, gridRoomVertexLoop }, gypsumCeilingId, room.Level.Id);
                    Parameter paramEle = gypCeiling.get_Parameter(BuiltInParameter.CEILING_HEIGHTABOVELEVEL_PARAM);
                    paramEle.Set(2550 / 304.8);
                ...
                string toolName = "Ceiling Matrix 2";
